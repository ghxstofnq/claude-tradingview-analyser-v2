...
3. Hand-grade the bundle using the strategy's 7-step checklist (`docs/strategy/README.md`). Write to `tests/fixtures/NNN-label.expected.md`. Cite every price with `<price> (<json.path>)`.
